 ...
 */
class ProjetoFormList extends TStandardFormList {
    ...
    function __construct() {
        ...
        $titulo = new TLabel('Cadastrar Projeto');
        ...
        $this->datagrid->addQuickColumn('Descrição', 'descricao', 'left', 200, new TAction(array($this, 'onReload')), array('order', 'nome'));
